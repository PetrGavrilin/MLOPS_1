...
print(f1_score( X_test, np.round(y_test), average='binary', normalize=False)) #Classification metrics can't handle a mix of continuous-multioutput and multiclass-multioutput targets
